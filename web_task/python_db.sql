...
CREATE DATABASE IF NOT EXISTS `addressbook` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `addressbook`;
...
CREATE TABLE IF NOT EXISTS `addresses` (
  ...
  `phone1` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping data for table addressbook.addresses: 500 rows
/*!40000 ALTER TABLE `addresses` DISABLE KEYS */;
INSERT INTO `addresses` (`ID`, `first_name`, `last_name`, `company_name`, `address`, `city`, `county`, `state`, `zip`, `phone1`, `phone2`, `email`, `web`) VALUES
